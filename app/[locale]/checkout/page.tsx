...
function CheckoutForm() {
  ...
  if (!mounted) {
    return (
      <>
        <Navbar />
        <div className="min-h-screen bg-petal pt-36" />
        <Footer />
      </>
    );
  }
  ...
  if (items.length === 0) {
    return (
      <>
        <Navbar />
        <div className="min-h-screen bg-petal px-4 pt-32 sm:pt-36 pb-20 max-w-lg mx-auto text-center">
          <h1
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-petal px-4 sm:px-6 py-10 pt-32 sm:pt-36">
