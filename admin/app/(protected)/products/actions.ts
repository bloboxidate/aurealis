...
import { assertAdminSession } from '@/lib/require-admin-session';
...
type Parsed = { err: string } | { data: { id: string; slug: string; name_en: string; name_ar: string; description_en: string; description_ar: string; image: string; price_egp: number; category: (typeof CAT)[number]; in_stock: boolean; featured: boolean } };
